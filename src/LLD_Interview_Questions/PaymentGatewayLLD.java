...
class Payment {
    ...
    public synchronized void updateStatus(PaymentStatus status) {
        this.status = status;
    }
...
class DummyProvider implements PaymentProvider {
    ...
    public boolean process(Payment payment) {
        System.out.println("Processing payment via external provider...");
        return true;
    }
}
...
class PaymentService {
    ...
    public Payment initiatePayment(
        ...
        ReentrantLock lock = lockManager.getLock(orderId);
        lock.lock();
...
public class PaymentGatewayLLD {
    ...
    public static void main(String[] args) {
        ...
        PaymentService service =
                new PaymentService(repository, provider, lockManager);
